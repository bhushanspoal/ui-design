...
class UserSerializer(serializers.ModelSerializer):
    groceries = serializers.PrimaryKeyRelatedField(many=True, queryset=Groceries.objects.all())
...
class CartSerializer(serializers.ModelSerializer):
    ...
    groceries =GroceriesSerializer(read_only=True, many=True)
    products = ProductSerializer(read_only=True, many=True)

    class Meta:
        model = Cart
        fields = ('cart_id', 'created_at', 'groceries', 'products')